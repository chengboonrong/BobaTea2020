//Width and height of map
 ...
 d3.csv("http://chengboonrong.github.io/BobaTea2020/latest_PM2.5_dataset.csv", function(data) {
	 color.domain([0,1,2,3,4,5]); // setting the range of the input data

	 // Load GeoJSON data and merge with states data
	 d3.json("http://chengboonrong.github.io/BobaTea2020/us-states.json", function(json) {
